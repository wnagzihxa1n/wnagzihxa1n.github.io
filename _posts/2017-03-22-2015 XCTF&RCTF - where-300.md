...
![IMAGE](/assets/resources/68C71F2058340F4008D5F53AEA9E5D54.png)

输入用户名和密码，长度要想等，用户名和密码的逆序串相等则输出字符串

返回Flag

![IMAGE](/assets/resources/452D4D83DC86A86E8E38B3E46D0DC2FA.png)

Oops，出题的大佬良心发现故意来个简单的？？？？？？

**Too simple sometimes naive**

![IMAGE](/assets/resources/C2ABB0A8E5BEA26BD59A829521B000F6.png)
...
![IMAGE](/assets/resources/3D24B7F0470AA5D22FEC7F580AFF4F2C.png)

再看`y`，看不出是什么，我就想："`y`会不会是Dex后面的数据，出题人把它拆分了"，但是怎么都合不上

![IMAGE](/assets/resources/1E68CFD30CA2BE3753E19AC8B41A9658.png)
...
![IMAGE](/assets/resources/441D5FB8F632199167D67B10FAE381C7.png)
...
![IMAGE](/assets/resources/395A5983CEB495741A7464B51EAC22ED.png)
...
![IMAGE](/assets/resources/E653F6287A81F49D343DB4916B518B72.png)
...
![IMAGE](/assets/resources/62DDCE8AA3364D774F47E36F7FC1CD60.png)
...
![IMAGE](/assets/resources/8D19D2814AD2885C08791E19D373BC38.png)

首先我们找一个正常的dex.classes文件，用010Editor解析一下

![IMAGE](/assets/resources/24FF0DB81B1CDC25C86A1D8C05D9BA0D.png)
...
![IMAGE](/assets/resources/4D046EAD33C5E90FFCA9EB10916559AC.png)
...
![IMAGE](/assets/resources/69683E1A2BFA3697B19AC4EC729B7DD4.png)

使用JEB打开修复后的Dex文件

![IMAGE](/assets/resources/86F23EF225CBABEB6D779F404D93EB7C.png)

发现`onCreate()`方法反编译失败

查看对应的smali代码

![IMAGE](/assets/resources/562294F2F8EB77BE33D60E2D97D89C84.png)

发现`onCreate()`方法的代码是`nop`，鉴于其它方法都是正常的，那么这里明显是被抽走了，搞过加固的同学肯定眼熟这种形式，运行时动态恢复指令，但是这里没有so，明显不是

踌躇之际，我突然想到还有一个`y`，长度是`0x94`

![IMAGE](/assets/resources/858A033B189BBE404F5A5304449DE87F.png)
...
![IMAGE](/assets/resources/74B6F5E93CF6AAAB3CED2D132A379CAB.png)

找到偏移后，使用Winhex找到Dex文件对应的偏移

![IMAGE](/assets/resources/92D953F404A4771CC3FB344BA8322CEF.png)

一大片空白，将`y`的数据拷贝进去

![IMAGE](/assets/resources/75B13D0EE817CB5095AE957C46D2F703.png)

保存之后使用JEB打开最终的Dex文件

![IMAGE](/assets/resources/7B118DC82BD02C6A8E32A4F228946367.png)
