...
![IMAGE](/assets/resources/F98999D6B1428310EACF038F94577943.png)

IDA载入so，没有动态注册，直接分析`parseText()`函数

前面会调用Java层的`meaasgeMe()`函数

![IMAGE](/assets/resources/3D63A01102C69B29CE19185049096419.png)
...
![IMAGE](/assets/resources/706389D1E6382F6CD566664EC5D635D4.png)
...
![IMAGE](/assets/resources/96A80408B7EBF211ECE2F5E56457FA95.png)

加下来有两个`j_j_j__`开头的函数，如果没有看出这里是RC4加密的秘钥初始化的话可以跟进去

![IMAGE](/assets/resources/6BF8448EF666E96DF16865D212403A86.png)

跟到最里面的实现，RC4的秘钥初始化有比较明显的特征

![IMAGE](/assets/resources/1EC36A71863125C73FBA54AF109349BB.png)

然后是后面的加密过程

![IMAGE](/assets/resources/9EA8FB41B430B4AE83294280AC2331B8.png)

跟进去，到最里面的实现过程，很明显的RC4加密

![IMAGE](/assets/resources/34CEAB44A73C163D8D9205FB24C82B62.png)

最后的逻辑非常清楚，就是拷贝RC4加密后的数据然后跟一个字符串对比

![IMAGE](/assets/resources/A9CD3A70E14735A3D304BC3BDFF8CEC8.png)
