...
![IMAGE](/assets/resources/C33F117BCB2FA645E765F4BD0DFBB6D0.png)

`readSec.checkRegCode()`函数两个参数分别是输入的注册码，还有一个通过另一个类来获取，具体是操作数据库，初步判断没有密码

![IMAGE](/assets/resources/3F0D5CE642C18349F5D44CBE63B3A727.png)

这个值可以使用数据库查看工具来查看

![IMAGE](/assets/resources/B56BEB70AC418871127004990E6CEDB0.png)
...
![IMAGE](/assets/resources/C93A712E0A5823C083CC6D3567DFCF3D.png)
...
![IMAGE](/assets/resources/693A2964E6194CAFD3E4B22BCFD55820.png)
