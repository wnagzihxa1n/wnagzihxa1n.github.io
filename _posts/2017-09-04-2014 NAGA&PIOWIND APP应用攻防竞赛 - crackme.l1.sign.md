...
![IMAGE](/assets/resources/3B361C16757CB1D4AE1D1E4DFAC52CAD.png)

动态调试把解密后的so文件dump出来

先查看加载的内存基址

![IMAGE](/assets/resources/1C53E94C712BCA058FFF30D365ABFAC0.png)
...
![IMAGE](/assets/resources/52D577FF8DAF95AE4666CE27A696E47D.png)
...
![IMAGE](/assets/resources/1B1F75D9C9BBC75CA6EE3B46F2A2FAAB.png)
...
![IMAGE](/assets/resources/3D13D00C1358815F7977ED540E6ADA4A.png)
...
![IMAGE](/assets/resources/6EF5BED9C8AA6FC811A713EBF441CBC8.png)
...
![IMAGE](/assets/resources/24DFAC64FB4DBB5D0E55A731F2F9BB41.png)

校验密码的合法性，格式为`xxx-xxx-xxx-xxx`

![IMAGE](/assets/resources/0714746A5D002960B238041FF74279AF.png)
...
![IMAGE](/assets/resources/28AF2748047F051F7ECA76C3FB287F70.png)
...
![IMAGE](/assets/resources/6128176EB44BD489A01ECFE753535B43.png)

动态运行时会填充数据，第一次运行时会进行Table的生成，通过对这个Table第一个字节的判断，如果是`00`，表示未生成，如果是`01`，表示Table已生成，则跳过初始化Table的代码段

动态运行时进行初始化

![IMAGE](/assets/resources/280D03D24C9E584F75E5DD386BBBC730.png)
...
![IMAGE](/assets/resources/C30454B8D16FDCB8D801D89672AD6D50.png)
...
![IMAGE](/assets/resources/7B21842EDABEC171568D1F236AB5D8A7.png)
...
![IMAGE](/assets/resources/236DBDC1F0300FE954D37F5069D5F198.png)
...
![IMAGE](/assets/resources/8AEA3EE649CFF9AF41CC88CB184B1798.png0)
...
![IMAGE](/assets/resources/BD8379EAEF5C860AC282DC1F5157A360.png)
...
![IMAGE](/assets/resources/ECA80B6A5DD3FEBC6808E9FE2342432F.png)
...
![IMAGE](/assets/resources/E4F689E401208AD9A3334F644F16035D.png)
...
![IMAGE](/assets/resources/B136CC7246DEBE02F6A373DC928677A3.png)