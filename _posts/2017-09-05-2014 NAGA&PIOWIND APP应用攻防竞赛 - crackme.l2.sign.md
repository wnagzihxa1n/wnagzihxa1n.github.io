---
layout: post
title:  "2014 NAGA&PIOWIND APP应用攻防竞赛 - crackme.l2.sign"
date:   2017-09-05 18:00:00 +520
categories: Android_CTF
---

Java层加了不知道是什么的花指令

![IMAGE](/assets/resources/BCB886053837B79B24414D5BA903FE9A.png)
...
![IMAGE](/assets/resources/11ABC6564768786413B34E4C6A83094A.png)
...
![IMAGE](/assets/resources/F03289BB06EFE7C80CDEA1F15DDA38E4.png)

我们找个正常的so文件的文件头拷贝回去，然后再使用IDA打开，发现可以打开了

![IMAGE](/assets/resources/77E31D24DC3112EDAFD57FA7BD5A328D.png)

我们继续分析，整个程序的结构和第一题是一样的

![IMAGE](/assets/resources/D8AA6E13486FFD5A6EB0D608024AEBB1.png)

新建内存空间

![IMAGE](/assets/resources/A0AF8001ACEDE1E989C48943B79A3E98.png)

Base64解码

![IMAGE](/assets/resources/35A24BDE8E99B1D38C7F04FE474EA370.png)

但是我们在最后校验的地方发现了不一样的地方，它校验的方式是反过来的

![IMAGE](/assets/resources/01C5B5B15959A43CEA08B30D6C245773.png)

突然界面就酷炫了起来

那么就比较简单了，注册码就是用户名倒序的Base64编码再插入`-`

![IMAGE](/assets/resources/289FCBD69F333B604F8A047F73DDF77F.png)
