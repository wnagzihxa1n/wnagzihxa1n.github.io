...
```
wnagzihxain@wnagzihxa1n:~$ file 2e204fe0ec33b1689f1c47bd60a9770c
...
```
wnagzihxain@wnagzihxa1n:~$ dd if=2e204fe0ec33b1689f1c47bd60a9770c.ab bs=1 skip=24 of=compressed
记录了8977280+0 的读入
记录了8977280+0 的写出
...
```
wnagzihxain@wnagzihxa1n:~$ tree apps
apps
